...
namespace DevAge.Data
{
    ...
    public class DataSetHelper
    {
        ...
        [ThreadStatic] private static DataTable tEmptyDataTable;

        private static DataTable EmptyDataTable // Multi-thread safe with [ThreadStatic] backing store
        {
            get
            {
                if (tEmptyDataTable == null)
                    tEmptyDataTable = new DataTable();

                return tEmptyDataTable;
            }
        }
        ...
        public static object Eval(string expression, params object[] parameters)
        {
            ...
            return EmptyDataTable.Compute(expToEvaluate, string.Empty);
        }
