...
namespace SourceGrid
{
	...
	public abstract class GridVirtual : CustomScrollControl
	{
		...
		public virtual void CheckPositions()
		{
            ...
            // Note: Reto (16-Aug-2008): The following code caused serious performance issues when multiple rows where selected, and the grid basically broke down completely when you selected all rows (Ctrl-A)
		...
		/// <returns></returns>
		public abstract Cells.ICellVirtual GetCell(int row, int column);
