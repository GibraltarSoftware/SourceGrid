...
namespace SourceGrid.Cells.Views
{
	...
	{
	    [ThreadStatic] private static Cell t_DefaultCell;

	    /// <summary>
	    /// Represents a default Model
	    /// </summary>
	    /// <remarks>This has been modified to be [ThreadStatic] to allow safe use from mulitple UI threads.</remarks>
	    public static Cell Default // Multi-thread safe with [ThreadStatic] backing store
	    {
            get
            {
                if (t_DefaultCell == null)
                    t_DefaultCell = new Cell();

                return t_DefaultCell;
            }
	    }
