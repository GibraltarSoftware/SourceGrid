...
namespace SourceGrid.Cells.Views
{
    ...
    {
        [ThreadStatic] private static ComboBox t_Default;

        /// <summary>
        /// Represents a default CheckBox with the CheckBox image align to the Middle Center of the cell.
        /// </summary>
        /// <remarks>You must use this VisualModel with a Cell of type ICellCheckBox.
        /// This default ComboBox is shared across the same UI thread, but not between threads.
        /// It can be cloned for a unique instance.</remarks>
        public new static ComboBox Default // Multi-thread safe with [ThreadStatic] backing store
        {
            get
            {
                if (t_Default == null)
                    t_Default = new ComboBox();
