...
namespace SourceGrid.Cells.Views
{
	...
	{
	    [ThreadStatic] private static Button t_Default;
	    ...
	    /// </summary>
	    /// <remarks>This default Button is shared across the same UI thread, but not between threads.  It can be cloned
	    /// for a unique instance.</remarks>
	    public new static Button Default // Multi-thread safe with [ThreadStatic] backing store
	    {
	        get
	        {
	            if (t_Default == null)
	                t_Default = new Button();
