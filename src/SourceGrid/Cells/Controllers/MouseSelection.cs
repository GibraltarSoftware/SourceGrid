...
namespace SourceGrid.Cells.Controllers
{
    ...
    {
        [ThreadStatic] private static MouseSelection t_DefaultSelection;

        public static MouseSelection Default // Multi-thread safe with [ThreadStatic] backing store
        {
            get
            {
                if (t_DefaultSelection == null)
                    t_DefaultSelection = new MouseSelection();

                return t_DefaultSelection;
            }
        }
