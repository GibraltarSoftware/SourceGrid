...
namespace SourceGrid.Cells.Controllers
{
	...
	public class CheckBox : ControllerBase
	{
	    ...
	    /// </summary>
	    /// <remarks>This default CheckBox controller is shared across a UI thread, but not between threads.</remarks>
	    public static CheckBox Default // Multi-thread safe with [ThreadStatic] backing store
	    {
	        get
	        {
	            if (t_Default == null)
