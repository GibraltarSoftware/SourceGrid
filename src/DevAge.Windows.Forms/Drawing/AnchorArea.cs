...
namespace DevAge.Drawing
{
    ...
    public class AnchorArea : ICloneable, IComparable
    {
        ...
        /// <summary>
        /// Construct an anchorarea class based on the aligment and the stretch parameters.
        /// </summary>
        ...
        /// <summary>
        /// Returns a new empty AnchorArea.
        /// </summary>
        /// <remarks>Each access returns a new instance as a fresh, empty starting point.  To check if a given
        /// AnchorArea is empty, check its IsEmpty property rather than compare to Empty.</remarks>
        public static AnchorArea Empty // Multi-thread safe, returns new instance each access.
        {
            get { return new AnchorArea(); }
        }

        /// <summary>
        /// Determines if the instance is empty (no anchoring set).
        /// </summary>
        public bool IsEmpty
        {
