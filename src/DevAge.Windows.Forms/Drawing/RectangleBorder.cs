...
namespace DevAge.Drawing
{
    ...
    {
        public readonly static RectangleBorder NoBorder = new RectangleBorder(BorderLine.NoBorder); // Multi-thread safe as a readonly RectangleBorder struct
        public readonly static RectangleBorder RectangleBlack1Width = new RectangleBorder(new BorderLine(Color.Black, 1)); // Multi-thread safe as a readonly RectangleBorder struct
        ...
        /// <summary>
        /// Change the padding of the current struct instance and return a copy of the modified struct.
        /// </summary>
