...
namespace DevAge.Drawing
{
	...
	{
		public readonly static BorderLine NoBorder = new BorderLine(Color.White, 0); // Multi-thread safe as a readonly struct
        public readonly static BorderLine Black1Width = new BorderLine(Color.Black, 1); // Multi-thread safe as a readonly struct
